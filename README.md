...
We welcome contributions from all MMAUG community members. See the [Contributing Guide](CONTRIBUTING.md) for full details.

**Quick start:**

1. Fork this repository
2. Create a new article in `_articles/` using the [article template](article-template.md)
3. Open a Pull Request
4. Get reviewed and published

## Topics

We welcome articles on topics including:

- Microsoft Azure (AI, cloud, security, DevOps)
- Azure AI Foundry, Copilot, and AI agents
- Open-source tools and frameworks
- Cloud architecture and best practices
- Hands-on tutorials and walkthroughs
- MMAUG meetup session recaps
...
Content in this repository is contributed by community members. All rights remain with the respective authors unless otherwise stated.
